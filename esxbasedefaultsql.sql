...
-- Dumping data for table es_extended.addon_account: ~3 rows (approximately)
...
-- Dumping data for table es_extended.addon_account_data: ~0 rows (approximately)
...
-- Dumping data for table es_extended.addon_inventory: ~3 rows (approximately)
...
-- Dumping data for table es_extended.datastore: ~2 rows (approximately)
...
-- Dumping data for table es_extended.datastore_data: ~0 rows (approximately)
...
-- Dumping data for table es_extended.items: ~4 rows (approximately)
DELETE FROM `items`;
...
-- Dumping data for table es_extended.jobs: ~4 rows (approximately)
DELETE FROM `jobs`;
...
-- Dumping data for table es_extended.job_grades: ~14 rows (approximately)
...
-- Dumping data for table es_extended.licenses: ~0 rows (approximately)
